...
namespace WorkOrganization.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20241204012847_ChangeDeleteBeahviourInTaskDependants")]
    partial class ChangeDeleteBeahviourInTaskDependants
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssigneeProject", b =>
                {
                    ...
                    b.ToTable("AssigneeProject", "work");
                });
            ...
            modelBuilder.Entity("AssigneeProject", b =>
                {
                    b.HasOne("WorkOrganization.Domain.Models.Assignee", null)
                        .WithMany()
                        .HasForeignKey("AssigneesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WorkOrganization.Domain.Models.Project", null)
                        .WithMany()
